      ...
      <CardContent className="p-6 flex flex-col items-center justify-center space-y-6">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            variant="outline"
            size="icon"
            className="rounded-full w-10 h-10 bg-gradient-to-r from-blue-200 to-purple-200 border-blue-300 hover:from-blue-300 hover:to-purple-300 text-gray-700 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110"
          ...
          <Button
            ...
            className={cn(
              ...
              isFavorited 
                ? "bg-gradient-to-r from-rose-300 to-pink-300 hover:from-rose-400 hover:to-pink-400 text-gray-700 shadow-lg hover:shadow-xl border-rose-300" 
                : "bg-gradient-to-r from-rose-100 to-pink-100 hover:from-rose-200 hover:to-pink-200 text-gray-700 shadow-lg hover:shadow-xl border-rose-200"
            )}
